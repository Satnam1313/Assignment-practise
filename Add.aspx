...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="form-group ">
      ...
      <div class="col-sm-6 ">
     <asp:FileUpload  CssClass="form-control btn-primary"   ID="ImageUpload" runat="server" Font-Names="Upload Image" Font-Strikeout="False" OnClick="ImageUpload_Click"  /><div style="padding-top: 5px"><asp:PlaceHolder   ID="PlaceHolder1" runat="server"><mark class="text-warning">It add the description to recipe</mark></asp:PlaceHolder></div>
      </div></div>
           </div>
